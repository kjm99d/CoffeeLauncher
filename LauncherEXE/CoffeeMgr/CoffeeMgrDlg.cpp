...
BEGIN_MESSAGE_MAP(CCoffeeMgrDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CCoffeeMgrDlg::OnBnClickedButton1)
END_MESSAGE_MAP()
...
void CCoffeeMgrDlg::OnBnClickedButton1()
{
	MessageBox(L"Start");
	...
	CreateProcess(L"CoffeeTray.exe", NULL, NULL, NULL, FALSE, 0, NULL, NULL, &si, &pi);
